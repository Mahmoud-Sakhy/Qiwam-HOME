...
export const metadata: Metadata = {
  title: "نوافذ Next.js المنبثقة | TailAdmin - قالب لوحة تحكم Next.js",
  description:
    "هذه صفحة النوافذ المنبثقة لـ Next.js الخاصة بـ TailAdmin - قالب لوحة تحكم إدارة CSS لـ Next.js Tailwind",
  // other metadata
};
