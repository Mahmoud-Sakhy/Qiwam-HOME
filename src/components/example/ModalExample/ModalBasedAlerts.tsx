...
export default function ModalBasedAlerts() {
  ...
  return (
    <ComponentCard title="تنبيهات النوافذ المنبثقة">
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
            تم إكمال المهمة بنجاح. استمر في العمل الجيد، أداؤك يتجاوز التوقعات ويسهم في تحقيق أهداف الفريق بشكل مميز.
          </p>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
            نود إعلامك بأن النظام قد تم تحديثه بنجاح. لا توجد إجراءات مطلوبة من جانبك، ولكن ننصحك بمراجعة التغييرات الجديدة.
          </p>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
            يرجى الانتباه! هناك تغييرات قادمة في النظام قد تؤثر على تجربتك. نوصي بمراجعة الإشعارات القادمة واتخاذ الإجراءات اللازمة عند الضرورة.
          </p>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
            حدث خطأ غير متوقع في النظام. الرجاء المحاولة مرة أخرى أو التواصل مع الدعم الفني إذا استمرت المشكلة.
          </p>
